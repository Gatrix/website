...
export default function HomeClient({ initialAdventures }: HomeClientProps) {
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 md:gap-16 items-center">
          ...
          <div className="relative group overflow-hidden">
            ...
            <div className="relative grid grid-cols-2 gap-4">
              <div className="aspect-[4/5] bg-[#1a1614] border border-amber-900/30 overflow-hidden grayscale hover:grayscale-0 transition-all duration-700 shadow-2xl p-2">
